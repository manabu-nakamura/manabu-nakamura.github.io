...
```xml
<resources>
    <style name="Theme.App" parent="Theme.Material3Expressive.DynamicColors.DayNight.NoActionBar.FocusRings">
        ...
    </style>
</resources>
```
