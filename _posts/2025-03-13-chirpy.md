...
⬇️
```html
 8 {% assign df_strftime_m = site.data.locales[lang].df.archives.strftime | default: '/ %d' %}
 9 {% assign df_dayjs_m = site.data.locales[lang].df.archives.dayjs | default: '/ DD' %}
